            ...
            <div
                ...
                <div class="flex-1">
                    <div class="flex items-center gap-3 mb-2">
                        <h2 class="text-3xl font-bold p-10"><strong>Subject:</strong>{{ $subject->subject_name }}</h2>
                    </div>
                </div>
            </div>
            <!-- Profile Card -->
                            ...
                            <div class="rounded-xl bg-dark shadow-md overflow-hidden exam-card" id="subject_card">
                                ...
                                <div class="p-6">
                                    ...
                                    <div class="flex items-center mb-4">
                                        ...
                                        <span class="text-sm text-white-500"> {{ \Carbon\Carbon::parse($exam->created_at)->format('F d, Y - h:i A') }}</span>
                                    </div>
