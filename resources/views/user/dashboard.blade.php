...
<html lang="en">
  <head>
    ...
    <style>
      ...
      .banner-container {
        ...
        height: 50vh;
        margin: 1rem auto;
        background: #1f1f1f; /* Dark background for banner */
      ...
      .card-text a {
        ...
        border-bottom: 1.5px solid #4caf50; /* Green underline */
      }
  ...
  <body>
    ...
    <div class="banner-container shadow-sm">
      <img
        src="https://storage.googleapis.com/workspace-0f70711f-8b4e-4d94-86f1-2a93ccde5887/image/0ad2cb31-e920-484f-a8e0-0cd5b072859d.png"
    ...
    <div class="option">
      ...
      <div class="cards-container">
        ...
        <!-- Card 2: Resume Test -->
        <div
          class="card-custom ca__fx-clipGridReveal"
          role="button"
          tabindex="0"
    ...
    <div class="wrapper">
      ...
      <a
        href="https://www.youtube.com/channel/UChtfH_vkJfThhBGduzmpBWw"
        class="button"
      >
        <div class="icon">
