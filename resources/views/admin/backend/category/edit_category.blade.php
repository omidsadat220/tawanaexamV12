                    ...
                    <form id="categoryForm" action="{{ route('update.category', $category->id) }}" method="POST">
                        ...
                        <div class="row">
                            <div class="col-12 d-flex align-items-center justify-content-between mb-3">
                                ...
                                <input class="catinput" type="text" id="categoryName" name="uni_name"
                                    value="{{ $category->uni_name }}" placeholder="Enter category name...">
                            </div>

                            <div class="col-12 d-flex align-items-center justify-content-between mb-3">
                                <label for="categoryName" class="text-start">Code</label>
                                <input class="catinput" type="text" id="categoryName" name="code"
                                    value="{{ $category->code }}" placeholder="Enter category name...">
                            </div>

                            <div class="col-4 d-flex align-items-center  justify-content-end  mb-3">
                                <label for="categoryName" class="text-start">Active</label>
                                <input class="catinput ms-2" type="checkbox" id="categoryName"
