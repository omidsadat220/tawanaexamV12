                  ...
                  <form id="categoryForm" action="{{route('store.category')}}"  method="POST">
                    ...
                    <div class="row">
                      <div class="col-12 d-flex align-items-center justify-content-between mb-3">
                        ...
                        <input class="catinput" type="text" id="categoryName" name="uni_name"  placeholder="Enter category name...">
                      </div>

                         <div class="col-12 d-flex align-items-center justify-content-between mb-3">
                        <label for="categoryName" class="text-start">Code</label>
                        <input class="catinput" type="text" id="categoryName" name="code"  placeholder="Enter category name...">
                      </div>
