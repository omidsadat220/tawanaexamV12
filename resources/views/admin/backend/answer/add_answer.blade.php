                    ...
                    <div class="row">
                      ...
                      @endforeach
                       ...
                       <div class="col-12 d-flex align-items-center justify-content-between mb-3">
                        ...
                        <input class="catinput" type="text" id="question_two" name="question_two"  placeholder="Enter question_two">
                      </div>

                        <div class="col-12 d-flex align-items-center justify-content-between mb-3">
                        <label for="categoryName" class="text-start">question_three</label>
                        <input class="catinput" type="text" id="question_three" name="question_three"  placeholder="Enter question_three">
                      </div>

                        <div class="col-12 d-flex align-items-center justify-content-between mb-3">
                        <label for="categoryName" class="text-start">question_four</label>
                        <input class="catinput" type="text" id="question_four" name="question_four"  placeholder="Enter question_four">
                      </div>

                      <div class="col-12 d-flex align-items-center justify-content-between mb-3">
                        <label for="categoryName" class="text-start">correct_answer</label>
                        <input class="catinput" type="text" id="correct_answer" name="correct_answer"  placeholder="Enter correct_answer">
                      </div>
