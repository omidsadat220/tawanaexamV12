                        ...
                        <div class="bg-secondary rounded h-100 p-4">
                            <form id="categoryForm" action="{{ route('store.answer') }}" method="POST">
                                ...
                                <div class="container text-start p-4 bg-secondary rounded ">
                                    ...
                                    {{-- Answer One --}}
                                    <div class="row mb-3 align-items-center">
                                        <label for="question_one" class="col-sm-2 col-form-label text-white">Answer
                                            One</label>
                                        <div class="col-sm-10">
                                            <input class="form-control catinput" type="text" id="question_one"
                                                name="question_one" placeholder="Enter answer one...">
                                        </div>
                                    </div>

                                    {{-- Answer Two --}}
                                    <div class="row mb-3 align-items-center">
                                        <label for="question_two" class="col-sm-2 col-form-label text-white">Answer
                                            Two</label>
                                        <div class="col-sm-10">
                                            <input class="form-control catinput" type="text" id="question_two"
                                                name="question_two" placeholder="Enter answer two...">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3 align-items-center">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control catinput" type="text" id="question_three"
                                                name="question_three" placeholder="Enter answer three...">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-3 align-items-center">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control catinput" type="text" id="question_four"
                                                name="question_four" placeholder="Enter answer four...">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mb-4 align-items-center">
                                        ...
                                        <div class="col-sm-10">
                                            <input class="form-control catinput" type="text" id="correct_answer"
                                                name="correct_answer" placeholder="Enter correct answer...">
                                        </div>
                                    </div>
